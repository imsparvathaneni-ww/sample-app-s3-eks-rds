...
app.get('/api/getUsers', cors(corsOptions), query.getUsers);
app.post('/api/addUser', cors(corsOptions), query.addUser);
app.delete('/api/deleteUser/:id', cors(corsOptions), query.deleteUser);
app.put('/api/updateUser/:id', cors(corsOptions), query.updateUser);
